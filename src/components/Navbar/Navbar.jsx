  ...
  return (
    <nav className="app__navbar">
      ...
      <ul className='app__navbar-links'>
        ...
        <li className='p__opensans'><NavLink to='/donate'>Donate</NavLink></li>
        <li className='p__opensans'><NavLink to='/login'>Receive</NavLink></li>
        <li className='p__opensans'><NavLink to='/about'>About</NavLink></li>
      </ul>

      <div className='app__navbar-login'>
        <NavLink to='/register' className='p__opensans'>Login/Register</NavLink>
      </div>
